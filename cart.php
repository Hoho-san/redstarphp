                ...
                <?php else : ?>
                    <form action="" method="post">
                            ...
                            <table class="table table-responsive table-hover table-bordered">
                                ...
                                <?php for ($i = 1; $i <= count($arr_cart_p_id); $i++) : ?>
                                    <tr>
                                        ...
                                        <td>Php <?php echo $arr_cart_p_current_price[$i]; ?></td>
                                        <td>
                                ...
                                <tr>
                                    ...
                                    <th class="total-amount">Php <?php echo $table_total_price; ?></th>
                                    <th></th>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="cart-buttons">
                            <ul>
                                <li><input type="submit" value="Update Cart" class="btn btn-primary" style="border-radius: 1rem;" name="form1"></li>
                                <li><a href="index.php" class="btn btn-primary" style="border-radius: 1rem;">Continue Shopping</a></li>
                                <li><a href="checkout.php" class="btn btn-primary" style="border-radius: 1rem;">Checkout</a></li>
                            </ul>
                        </div>
                    </form>
                <?php endif; ?>
