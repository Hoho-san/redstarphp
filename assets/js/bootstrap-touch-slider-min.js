    ...
    function t(e, t) {
        function r(e) {
            if (
                !(
                    cn() ||
                    n(e.target).closest(t.excludedElements, Wn).length > 0
                )
            ) {
                ...
                if (
                    ...
                    return (
                        ...
                        un(),
                        pn(0, a),
                        !o || Gn === t.fingers || t.fingers === b || X()
                            ? ((Bn = Mn()),
                              2 == Gn &&
                                  (pn(1, o[1]),
                                  (_n = qn = mn(Zn[0].start, Zn[1].start))),
                    ...
                    2 == Gn &&
                        (0 == _n
                            ? (pn(1, i[1]),
                              (_n = qn = mn(Zn[0].start, Zn[1].start)))
                            : (dn(i[1]),
                              (qn = mn(Zn[0].end, Zn[1].end)),
                              (Yn = yn(Zn[0].end, Zn[1].end))),
                        (Fn = En(_n, qn)),
                        (Xn = Math.abs(_n - qn))),
                    Gn === t.fingers || t.fingers === b || !i || X())
                ) {
                    if (
                        ((Hn = On(a.start, a.end)),
                        (Cn = On(a.last, a.end)),
                        ...
                        !t.triggerOnTouchEnd && l
                            ? (zn = I(y))
                            : t.triggerOnTouchLeave && !l && (zn = I(x)),
                            (zn == S || zn == x) && U(e, zn);
                    }
                } else (zn = S), U(e, zn);
                r === !1 && ((zn = S), U(e, zn));
        ...
        function k(n) {
            ...
            return (
                ...
                C() || !H()
                    ? ((zn = S), U(e, zn))
                    : t.triggerOnTouchEnd ||
                      (t.triggerOnTouchEnd === !1 && zn === y)
                    ? (t.preventDefaultEvents !== !1 && n.preventDefault(),
                      (zn = x),
                      U(e, zn))
            ...
            return (
                !r || o
                    ...
                    : !i ||
                      n != y ||
                      (t.triggerOnTouchEnd && !t.triggerOnTouchLeave)
                    ? !i && n == x && t.triggerOnTouchLeave && (e = S)
                    : (e = x),
                e
            );
        }
            ...
            if (c == p) {
                ...
                if (r == x && V()) {
                    if (
                        (clearTimeout(ee),
                        clearTimeout(te),
                        Wn.trigger("swipe", [Hn, Nn, Qn, Gn, Zn, Cn]),
                        t.swipe &&
                            ((f = t.swipe.call(Wn, e, Hn, Nn, Qn, Gn, Zn, Cn)),
                            f === !1))
                    )
                        return !1;
                    switch (Hn) {
                        case i:
                            Wn.trigger("swipeLeft", [Hn, Nn, Qn, Gn, Zn, Cn]),
                                t.swipeLeft &&
                                    (f = t.swipeLeft.call(
                                        Wn,
                                        e,
                            ...
                            break;
                        case o:
                            Wn.trigger("swipeRight", [Hn, Nn, Qn, Gn, Zn, Cn]),
                                t.swipeRight &&
                                    (f = t.swipeRight.call(
                                        Wn,
                                        e,
                            ...
                            break;
                        case a:
                            Wn.trigger("swipeUp", [Hn, Nn, Qn, Gn, Zn, Cn]),
                                t.swipeUp &&
                                    (f = t.swipeUp.call(
                                        Wn,
                                        e,
                            ...
                            break;
                        case l:
                            Wn.trigger("swipeDown", [Hn, Nn, Qn, Gn, Zn, Cn]),
                                t.swipeDown &&
                                    (f = t.swipeDown.call(
                                        Wn,
                                        e,
                      ...
                      J() && !nn()
                          ? ((ne = Mn()),
                            (ee = setTimeout(
                                n.proxy(function () {
                                    (ne = null),
                                        Wn.trigger("tap", [e.target]),
                                        t.tap &&
                                            (f = t.tap.call(Wn, e, e.target));
                                }, this),
                                t.doubleTapThreshold
                            )))
                          : ((ne = null),
                            Wn.trigger("tap", [e.target]),
                            t.tap && (f = t.tap.call(Wn, e, e.target))))
                    : c == g
                    ? (r === S || r === x) &&
                      (clearTimeout(ee),
                      clearTimeout(te),
                      (ne = null),
                      Wn.trigger("doubletap", [e.target]),
                      t.doubleTap && (f = t.doubleTap.call(Wn, e, e.target)))
                    : c == v &&
                      (r === S || r === x) &&
                      (clearTimeout(ee),
                      (ne = null),
                      Wn.trigger("longtap", [e.target]),
                      t.longTap && (f = t.longTap.call(Wn, e, e.target))),
                f
            );
        }
        function H() {
        ...
        function _() {
            var n;
            return (n =
                t.maxTimeThreshold && Qn >= t.maxTimeThreshold ? !1 : !0);
        }
        function q(n, e) {
        ...
        function fn(n) {
            Wn &&
                (n === !0
                    ? (Wn.bind(An, L), Wn.bind(jn, k), In && Wn.bind(In, A))
                    : (Wn.unbind(An, L, !1),
                      Wn.unbind(jn, k, !1),
                      In && Wn.unbind(In, A, !1)),
                Wn.data(P + "_intouch", n === !0));
        }
        function pn(n, e) {
            var t = {
                start: { x: 0, y: 0 },
            ...
            return (
                (t.start.x = t.last.x = t.end.x = e.pageX || e.clientX),
                (t.start.y = t.last.y = t.end.y = e.pageY || e.clientY),
                (Zn[n] = t),
                t
            );
        }
        ...
        function xn(n, e) {
            return Math.round(
                Math.sqrt(Math.pow(e.x - n.x, 2) + Math.pow(e.y - n.y, 2))
            );
        }
        function Sn(n, e) {
            var t = n.x - e.x,
        ...
        function Pn(n, e) {
            return (
                n.x > e.left && n.x < e.right && n.y > e.top && n.y < e.bottom
            );
        }
        function Ln(n, e) {
        ...
        try {
            ...
            n.error(
                "events not supported " + Rn + "," + Un + " on jQuery.swipe"
            );
        }
