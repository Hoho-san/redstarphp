...
if (isset($_POST['form1'])) {
    ...
    if ($valid == 1) {
        ...
        if ($path == '') {
            $statement = $pdo->prepare("UPDATE tbl_slider SET heading=?, content=?,  position=? WHERE id=?");
            ...
            $statement = $pdo->prepare("UPDATE tbl_slider SET photo=?, heading=?, content=?, position=? WHERE id=?");
