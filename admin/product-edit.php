            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">Current Price in Peso *</label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="p_description" class="form-control" cols="30" rows="10"><?php echo $p_description; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
